...
// Used in converting case in UTF8 strings safely (until PHP6 anyway)

// Source: MediaWiki /trunk/phase3/includes/Utf8Case.php

$GLOBALS['ocUpperChars'] = array(
    "a" => "A",
    "b" => "B",
    "c" => "C",
    "d" => "D",
